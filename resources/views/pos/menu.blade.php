    ...
    <div x-data="{
        ...
        addToCart(item) {
            if (!navigator.onLine) { // Only allow offline cart if offline
                ...
                console.log('Cart saved offline:', this.cart);
            }
        }
    }">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center gap-3">
                    <div class="flex-1">
                        <form action="#" method="GET">
                            ...
                            <div class="relative">
                                ...
                                <x-input
                                    class="block w-full pl-10 pr-10 py-2 border-gray-200 rounded-lg text-sm focus:ring-skin-base focus:border-skin-base"
                                    type="text" placeholder="{{ __('placeholders.searchMenuItems') }}"
                                ...
                                @if ($search)
                                    <button type="button" wire:click="$set('search', '')"
                                        ...
                                        <svg class="w-5 h-5" width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <path d="M20 20 4 4m16 0L4 20" stroke="currentColor" stroke-width="2"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 lg:w-[28rem]">
                        <div class="relative">
                            ...
                            <select id="menu-filter" wire:model.live="menuId"
                                class="block w-full pl-9 pr-3 py-2 text-sm rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-200 focus:ring-skin-base focus:border-skin-base">
                        ...
                        <div class="relative">
                            ...
                            <select id="category-filter" wire:model.live="filterCategories"
                                class="block w-full pl-9 pr-3 py-2 text-sm rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-200 focus:ring-skin-base focus:border-skin-base">
                        ...
                        <li class="group relative flex items-center justify-center">
                            ...
                            <label for="item-{{ $item->id }}" @class([
                                ...
                                'cursor-pointer hover:shadow-md dark:hover:bg-gray-700/30 peer-checked:ring-2 peer-checked:ring-skin-base active:scale-95 focus-visible:scale-95 focus-visible:ring-2 focus-visible:ring-skin-base' =>
                                    !$orderLimitReached && $item->in_stock,
