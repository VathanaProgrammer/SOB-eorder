<div>
    <form wire:submit="save" class="space-y-4">
        ...
        <div x-data="{
            preview: '{{ $existingReceiptUrl ?? asset('img/receipt-icon.jpg') }}',
            showPreview: {{ isset($existingReceiptUrl) && preg_match('/\.(jpg|jpeg|png|gif|webp|svg)$/i', $existingReceiptUrl) ? 'true' : 'false' }},
            ...
            if (file) {
                ...
                preview = '{{ asset('img/file-icon.png') }}';
                showPreview = false;
                }
            } else {
                preview = '{{ $existingReceiptUrl ?? asset('img/receipt-icon.jpg') }}';
                showPreview = {{ isset($existingReceiptUrl) && preg_match('/\.(jpg|jpeg|png|gif|webp)$/i', $existingReceiptUrl) ? 'true' : 'false' }};
            }
            " />
            </div>
            ...
            <!-- Preview -->
            <div class="mt-3" x-show="showPreview">
