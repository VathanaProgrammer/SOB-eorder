                                ...
                                <div class="flex items-start justify-between gap-3">
                                    <div class="space-y-1">
                                        ...
                                        <div class="flex flex-wrap items-center gap-1.5 text-xs text-gray-600 dark:text-gray-400">
                                            @php
                                                // Set price context for all modifiers before calculating
                                    ...
                                    <span class="text-sm font-semibold text-gray-900 dark:text-white whitespace-nowrap">
                                        {{ currency_format(($item->price + $modifierTotal) * $item->quantity, $restaurant->currency_id) }}
                                    </span>
                                </div>
                ...
                <div class="flex gap-4">
                    ...
                    @else
                        <div class="grid w-full grid-cols-2 gap-4">
                            @if ($paymentGateway->is_qr_payment_enabled || $paymentGateway->stripe_status || $paymentGateway->razorpay_status || $paymentGateway->is_offline_payment_enabled || $paymentGateway->flutterwave_status || $paymentGateway->paypal_status || $paymentGateway->epay_status)
