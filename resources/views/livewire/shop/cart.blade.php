    ...
    @if (!$showCart && !$showOrderTypeModal)
        ...
        <div class="grid grid-cols-3 gap-4 mx-4 my-6 sm:flex-row sm:items-center">
            ...
            <div class="flex flex-row flex-wrap items-center justify-end w-full col-span-2 gap-4 mt-2 md:col-span-1 sm:w-auto">
                ...
                <label class="items-center cursor-pointer hidden" id="veg_toggle">
                                                ...
                                                @if (isset($cartItemQty[$item->id]) && $cartItemQty[$item->id] > 0)
                                                    ...
                                                    @else
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            class="min-w-10 bg-white border-x-0 border-gray-300 h-8 text-center text-gray-900 text-sm  block w-full md:w-96 py-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white "
                                                            value="1" readonly />
                                                        <button type="button"
                                                            wire:click="
